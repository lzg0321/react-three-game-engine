...
export declare type ContextState = {
    ...
    addSubscription: (uuid: ValidUUID, objectRef: MutableRefObject<Object3D>, applyAngle: boolean) => () => void;
};
...
export declare const useAddMeshSubscription: () => (uuid: ValidUUID, objectRef: MutableRefObject<Object3D>, applyAngle: boolean) => () => void;
export declare const useSubscribeMesh: (uuid: ValidUUID, objectRef: MutableRefObject<Object3D>, applyAngle?: boolean, isDynamic?: boolean) => void;
