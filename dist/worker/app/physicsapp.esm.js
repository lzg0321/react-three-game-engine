...
import { Circle, Vec2, Box, DistanceJoint, RopeJoint, World as World$1 } from 'planck-js';
          ...
          switch (shape) {
            case BodyShape.box:
              var hx = fixture.hx,
                  ...
                  angle = fixture.angle;
              bodyShape = Box(hx / 2, hy / 2, center ? Vec2(center[0], center[1]) : undefined, angle);
              break;
            ...
            case BodyShape.circle:
              ...
              if (position) {
                bodyShape = Circle(Vec2(position[0], position[1]), radius);
              } else {
          ...
          if (attachToRope) {
            ...
            if (body) {
              var distanceJoint = DistanceJoint({
                ...
                dampingRatio: 0.5,
                length: 0.15
              }, startingBody, body, _position != null ? _position : Vec2(0, 0), _position != null ? _position : Vec2(0, 0));
              var rope2 = world.createJoint(RopeJoint(ropeJointDef, startingBody, body, _position != null ? _position : Vec2(0, 0)));
...
var useSendPhysicsUpdates = function useSendPhysicsUpdates(tickRef) {
  ...
  var update = useCallback(function (isMain) {
    if (isMain) {
  ...
  return useCallback(function (isMain) {
...
var useWorldLoop = function useWorldLoop() {
  ...
  var lastSentMainUpdateRef = useRef(-1);
  var lastSentLogicUpdateRef = useRef(-1);
...
var useHandleBeginCollision = function useHandleBeginCollision() {
  ...
  var sendCollisionBeginEvent = useCallback(function (uuid, data, fixtureIndex, collidedFixtureIndex, isSensor) {
    var update = {
...
var useHandleEndCollision = function useHandleEndCollision() {
  ...
  var sendCollisionEndEvent = useCallback(function (uuid, data, fixtureIndex, collidedFixtureIndex, isSensor) {
    var update = {
